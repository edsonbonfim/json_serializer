...
class Sample {
  final num notNullable;
  final num notNullableWithDefault;
  final num? nullable;
  final num? nullableWithDefault;
...
void main() {
  ...
  test('3', () {
    ...
    // Then
    expect(act, throwsWithMessage("type 'Null' is not a subtype of type 'num' of 'notNullable'"));
  });
